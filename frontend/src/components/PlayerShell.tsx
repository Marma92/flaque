      ...
      >
        {activeView !== "player" ? (
          <div className="mb-2 flex justify-center">
            <button
              className="flex h-7 w-10 items-center justify-center rounded-full border border-flaque-clay/60 bg-white/90 text-flaque-steel transition hover:bg-flaque-cream"
              type="button"
        ...
        {activeView === "player" ? (
          <div className="pointer-events-none absolute inset-x-0 bottom-3 flex justify-center">
            <button
              className="pointer-events-auto flex h-8 w-12 items-center justify-center rounded-full border border-flaque-clay/70 bg-white/90 text-flaque-steel transition hover:bg-flaque-cream"
              type="button"
