...
const log = createLogger("unified-playlist");

/**
 * Unified playlist router with clear sub-path grouping:
 ...
 */
export function createUnifiedPlaylistRouter(indexStore: IndexStore): Router {
  const router = Router();
...
// Helper functions (copied from original playlistRoutes.ts)
